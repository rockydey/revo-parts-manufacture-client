...
const Banner = () => {
    return (
        <div className='h-[60vh] flex flex-col items-center justify-center' style={{ background: `url(${banner})`, backgroundPosition: "center", backgroundRepeat: "no-repeat" }}>
            ...
            <a href='#parts' className='btn btn-primary md:mt-5 mt-4 text-base font-semibold'>Explore</a>
        </div>
    );
};
