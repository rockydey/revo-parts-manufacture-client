        ...
        <section className="card bg-base-100 shadow-xl">
            ...
            <div className="card-body">
                ...
                <div className="card-actions justify-end">
                    <button onClick={() => handlePurchase(_id)} className="btn bg-gradient-to-r from-secondary to-primary text-white outline-0">Update</button>
                </div>
            </div>
        </section>
    );
